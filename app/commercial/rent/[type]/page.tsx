type CommercialRentTypePageProps = {
  params: Promise<{
    type: string;
  }>;
};
...
export default async function CommercialRentTypePage({
  params,
}: CommercialRentTypePageProps) {
    ...
    <main className="min-h-screen bg-[#05070D] px-6 py-32 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
          Explore available {propertyType.toLowerCase()} rental opportunities
          with SPEDO.
        </p>
