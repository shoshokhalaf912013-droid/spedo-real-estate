    ...
    <main className="min-h-screen bg-[#05070D] px-6 py-32 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
          Discover carefully selected resale opportunities across residential
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {propertyTypes.map((propertyType) => (
            <Link
              key={propertyType}
              href={`/sale/${propertyType.toLowerCase()}`}
            ...
            >
              ...
              <p className="mt-3 text-slate-400">
                Explore available {propertyType.toLowerCase()} resale
                opportunities.
              </p>
            </Link>
          ))}
