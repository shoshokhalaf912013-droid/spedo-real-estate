    ...
    <main className="min-h-screen bg-[#05070D] px-6 py-32 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
          Explore available {propertyType.toLowerCase()} properties and
          investment opportunities with SPEDO.
        </p>
        ...
        <div className="mt-14 rounded-[32px] border border-white/10 bg-[#07111D] p-10">
          ...
          <p className="mt-4 text-slate-400">
            Matching property listings will appear here after being published
